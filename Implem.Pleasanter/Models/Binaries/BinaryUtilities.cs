...
namespace Implem.Pleasanter.Models
{
    public static class BinaryUtilities
    {
        ...
        /// Fixed:
        /// </summary>
        public static string UploadImage(ICollection<IFormFile> files, long id)
        {
        ...
        /// Fixed:
        /// </summary>
        public static string MultiUpload(ICollection<IFormFile> files, long id)
        {
            var controlId = Forms.ControlId();
            var ss = new ItemModel(id).GetSite(initSiteSettings: true).SiteSettings;
        ...
        /// Fixed:
        /// </summary>
        public static Microsoft.AspNetCore.Mvc.FileContentResult Donwload(string guid)
        {
