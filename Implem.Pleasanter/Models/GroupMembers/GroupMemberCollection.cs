...
namespace Implem.Pleasanter.Models
{
    ...
    public class GroupMemberCollection : List<GroupMemberModel>
    {
        ...
        public GroupMemberCollection(IEnumerable<DataRow> dataRows)
        {
            Set(dataRows);
        }

        private GroupMemberCollection Set(IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new GroupMemberModel(dataRow));
                }
