...
namespace Implem.Pleasanter.Models
{
    ...
    public class WikiCollection : List<WikiModel>
    {
        ...
        public WikiCollection(SiteSettings ss, IEnumerable<DataRow> dataRows)
        {
            Set(ss, dataRows);
        }

        private WikiCollection Set(SiteSettings ss, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new WikiModel(ss, dataRow));
                }
