...
namespace Implem.Pleasanter.Models
{
    ...
    public class UserCollection : List<UserModel>
    {
        ...
        public UserCollection(SiteSettings ss, IEnumerable<DataRow> dataRows)
        {
            Set(ss, dataRows);
        }

        private UserCollection Set(SiteSettings ss, IEnumerable<DataRow> dataRows)
        {
            if (dataRows.Any())
            {
                foreach (DataRow dataRow in dataRows)
                {
                    Add(new UserModel(ss, dataRow));
                }
